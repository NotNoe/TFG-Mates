...
\include{Capitulos/2-Diferencias_finitas}
\include{Capitulos/3-Heat_Eq}
\include{Capitulos/4-Wave_Eq}
\include{Capitulos/5-Laplace_Eq}
\include{Capitulos/6-Algoritmos_Clasicos}
\include{Capitulos/7-ComputacionEnGPU}
\include{Capitulos/8-Algoritmos_GPU}
